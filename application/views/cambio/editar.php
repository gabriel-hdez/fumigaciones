...
?>
	...
	<section class="container height" style="padding-top: 2em;">
		<form id="myForm" enctype="multipart/form-data" method="POST" action="<?php echo base_url('cambio/actualizar');?>">

			<input type="hidden" name="id" value="<?php echo $dolar->id_dolar;?>">

			<div class="row">
				<div class="col s4 push-s4 input-field">
					<input id="bolivares" name="bolivares" type="text" class="validate" placeholder="0.00" value="<?php echo $dolar->bolivares;?>">
