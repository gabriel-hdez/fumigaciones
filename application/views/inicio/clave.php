				...
				<div class="col s8 push-s2">					
					<div class="card">
						<div class="row"> 
							...
							<form id="myform" accept-charset="utf-8" enctype="multipart/form-data" method="post" action="<?php echo base_url('recuperar/actualizar');?>">
								
								<div class="row">
									<div class="input-field col s12 m6 push-m3">
						              <input id="clave" name="clave" type="password" class="validate">
						              <label for="clave" class="active">NUEVA CONTRASEÑA</label>
								...
								<div class="row">
									<div class="input-field col s12 m6 push-m3">
						              ...
						              <label for="confirmar" class="active">CONFIRMAR CONTRASEÑA</label>
						              <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
						            </div>
								</div>
								
								<div class="row center">
									 <button class="waves-effect btn-large waves-light btn" type="submit" >ACTUALIZAR DATOS</button>
								</div>
							</form>
