				...
				<div class="col s8 push-s2">					
					<div class="card">
						<div class="row"> 
							...
							<form id="myform" accept-charset="utf-8" enctype="multipart/form-data" method="post" action="<?php echo base_url('recuperar/verificar');?>">
								
								<div class="row">
									<div class="input-field col s12 m6 push-m3">
						              <input id="pregunta" name="pregunta" type="text" class="validate" value="<?php echo $this->encryption->decrypt($usuario->pregunta); ?>" disabled="disabled">
						              <label for="pregunta" class="active">PREGUNTA DE SEGURIDAD</label>
								...
								<div class="row">
									<div class="input-field col s12 m6 push-m3">
						              ...
						              <label for="respuesta" class="active">RESPUESTA</label>
						              <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
						            </div>
								</div>
