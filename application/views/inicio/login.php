				...
				<div class="col s8 push-s2">					
					<div class="card">
						<div class="row"> 
							...
							<form id="myform" accept-charset="utf-8" enctype="multipart/form-data" method="post" action="<?php echo base_url('inicio/login');?>">
								
								<div class="row">
									<div class="input-field col s12 m6 push-m3">
						              <input id="correo" name="correo" type="text" class="validate">
						              <label for="correo" class="active">USUARIO</label>
								...
								<div class="row center">
									 <button class="waves-effect btn-large waves-light btn" type="submit" >INICIAR SESION</button>
								</div>
							</form>


							<div class="row center">
								<a href="<?php echo base_url('recuperar');?>" class="modal-close waves-effect waves-light btn-flat">RECUPERAR MIS DATOS</a>
							</div>
